...
, section 35(1) of the Jobseekers Act or section 17(1) of the State Pension Credit Act  % Words substituted (7.4.03) by SI 2002/3019 reg 16(b)
...
% Definition of ``out of jurisdiction appeal'' substituted (5.5.03) by SI 2003/1050 reg 3(1)
...
% Words omitted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 2(c)
\opt{oldrules}{
as extended by paragraph 3 of Schedule 4C to that Act\footnote{\frenchspacing Schedule 4C of the Child Support Act 1991 is inserted by paragraph 54 of Schedule 7 to the Social Security Act 1998.}
}%
or section 12(2);
\end{enumerate}
...
%Words substituted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 2(d)
\opt{oldrules}{%
departure direction 
}%
\opt{newrules,2012rules}{%
...
2.  Where, by any provision of the Act\opt{oldrules}{ }%
...
\addtocontents{toc}{\protect\medskip\protect\pagebreak[3]}
...
\opt{newrules,2012rules}{
\section[Part II --- Revisions, supersessions and other matters social security and child support]{Part II\\*Revisions, supersessions and other matters social security and child support}
...
\opt{newrules,2012rules}{
\subsubsection[3A. Revision of child support decisions]{Revision of child support decisions}
...
($cc$) if an appeal is made under section 20 of the Child Support Act against a decision within the time prescribed in regulation 31, or in a case to which regulation 32 applies within the time prescribed in that regulation, but the appeal has not been determined;
...
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 6(b)
\opt{newrules,2012rules}{%
the relevant person,
}%
...
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 6(c)
\opt{newrules,2012rules}{
or 3A%
}%
.
...
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 6(d)
\opt{newrules,2012rules}{%
...
($b$) that a Commissioner\opt{oldrules}{ }% 
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 6(a)
\opt{newrules,2012rules}{%
...
\opt{newrules,2012rules}{
\subsubsection[5A. Date from which a decision revised under section 16 of the Child Support Act takes effect]{Date from which a decision revised under section 16 of the Child Support Act takes effect}
...
($a$) is, except for 
%paragraph (2)($b$)
paragraphs (2)($b$), (29) and (30)%  % Words substituted (5.5.03) by SI 2003/1050 reg 3(5)(a)
...
or
    ...
    (iii) 
    paragraph 11 or 12 of Schedule II to the State Pension Credit Regulations; and % Words substituted (7.4.03) by SI 2003/3019 reg 18(d)
\end{enumerate}
...
\opt{newrules,2012rules}{
\subsubsection[15A. Provision of information]{Provision of information}
...
\subsubsection[15B. Procedure in relation to an application made under section 16 or 17 of the Child Support Act in connection with a previously determined variation]{Procedure in relation to an application made under section 16 or 17 of the Child Support Act in connection with a previously determined variation}
...
\opt{newrules,2012rules}{non-resident parent }%  % Words substituted for new-rules cases by SI 2001/158 reg 4(2)
...
\opt{newrules,2012rules}{calculation}%  % Word substituted for new-rules cases by SI 2001/158 reg 4(3)
...
\opt{newrules,2012rules}{
\subsubsection[30. Appeal against a decision which has been replaced or revised]{Appeal against a decision which has been replaced or revised}
}
...
% Words substituted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 11(b)(i)
\opt{oldrules}{%
...
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 11(b)(ii)
\opt{newrules,2012rules}{%
replaced or
}%
revised is not more advantageous to the appellant than the decision before it was 
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 11(b)(iii)
\opt{newrules,2012rules}{%
replaced or
}%
revised.
...
% Words substituted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 11(c)(i)
\opt{oldrules}{%
...
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 11(c)(ii)
\opt{newrules,2012rules}{%
replaced or
}%
revised, the appeal shall be treated as though it had been brought against the decision as 
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 11(c)(iii)
\opt{newrules,2012rules}{%
replaced or
}%
revised.
...
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 11(d)
\opt{newrules,2012rules}{%
replaced or
}%
...
% Words inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 11(e)
\opt{newrules,2012rules}{%
replaced or
}%
revised.
...
% Reg 30A inserted (3.3.03 for new-rules cases only) by SI 2000/3185 reg 12
\opt{newrules,2012rules}{
\subsubsection[30A. Appeals to appeal tribunals in child support cases]{Appeals to appeal tribunals in child support cases}
...
\opt{newrules,2012rules}{or 3A(1) }%  % Words inserted (3.3.03) for new-rules cases only by SI 2002/1204 reg 2(5)
...
a person has appealed to an appeal tribunal and it appears to the appeal tribunal, or a legally qualified panel member,  % Words substituted (20.5.02) by SI 2002/1379 reg 12(a)
...
or legally qualified panel member, as the case may be,  % Words inserted (20.5.02) by SI 2002/1379 reg 12(b)
shall—
\begin{enumerate}\item[]
...
% Reg 54(13) substituted (20.5.02) by SI 2002/1379 reg 17(e)
(13) In calculating the time specified for applying in writing for a statement of the reasons for the tribunal’s decision there shall be disregarded any day which falls before the day on which notice was given of—
\begin{enumerate}\item[]
($a$) a correction of a decision or the record thereof pursuant to regulation 56; or
