...
\opt{oldrules}{(2) In these Regulations “the Act” means the Child Support Act 1991.}
% Reg 1(2) substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(2)(a)
\opt{newrules}{
...
\opt{oldrules}{the second day after the day of posting, excluding any Sunday or any day which is a bank holiday under the Banking and Financial Dealings Act 1971\footnote{\frenchspacing 1971 c. 80.}.}\opt{newrules}{the day that it is posted.}  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(2)(c)
\end{enumerate}
...
\opt{oldrules}{assessment}\opt{newrules}{calculation}  % Word substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(3)(a)
...
\opt{newrules}{, penalty payments, interest and fees}  % Words inserted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(3)(b)(i)
...
($e$) in cash\opt{newrules}{;

% Reg 3(1)(f) inserted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(3)(b)(ii)
($f$) by debit card%
}.
\end{enumerate}

\opt{newrules}{
% Reg 3(1A) inserted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(3)(c)
...
\opt{newrules}{
\amendment{
Words inserted in reg. 3(1), word substituted in reg. 3(2) and reg. 3(1)(f), (1A) inserted (3.3.03 for new-rules cases only) by the Child Support (Collection and Enforcement and Miscellaneous Amendments) Regulations 2000 reg. 2(3)(a), (b), (c) (subject to savings in reg. 6).
}
}
...
\subsection[5A. Voluntary payments]{Voluntary payments}
...
7.—(1) 
\opt{newrules}{In the case of child support maintenance, t}\opt{oldrules}{T}he  % Words inserted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(3)(e)(i)(aa)
...
($c$) the method of payment; \opt{oldrules}{and}

($d$) the day and interval by reference to which payments are to be made\opt{newrules}{; and
...
\subsection[7A. Payment of a financial penalty]{Payment of a financial penalty}
...
\opt{oldrules}{“exempt income” means the amount determined under regulation 9 of the Child Support (Maintenance Assessments and Special Cases) Regulations 1992;}
...
\opt{oldrules}{“interim maintenance assessment” means a Category A, Category B, Category C or Category D interim maintenance assessment within the meaning of 
%regulation 8(1B) 
...
\opt{oldrules}{“prescribed minimum amount” means the minimum amount prescribed in regulation 13 of the Child Support (Maintenance Assessments and Special Cases) Regulations 1992;}

% Definition of ``protected earnings rate'' omitted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(a)(i)
\opt{oldrules}{“protected earnings rate” means the level of earnings specified in a deduction from earnings order (expressed as a sum of money per week, month or other period) below which deductions of child support maintenance shall not be made for the purposes of this Part;}

% Definition of ``protected income level'' omitted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(a)(i)
\opt{oldrules}{“protected income level” means the level of protected income determined in accordance with 
...
($e$) the 
\opt{oldrules}{protected earnings rate}\opt{newrules}{protected earnings proportion};  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(b)
...
\opt{oldrules}{(2) The Secretary of State, in specifying the normal deduction rate, shall not include any amount in respect of arrears or interest% 
...
\subsection[11. \opt{oldrules}{Protected earnings rate}\opt{newrules}{Protected earnings proportion}]{\opt{oldrules}{Protected earnings rate}\opt{newrules}{Protected earnings proportion}}  % Words substituted in heading to reg 11 (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(d)(i)

11.—(1) The period by reference to which the 
\opt{oldrules}{protected earnings rate}\opt{newrules}{protected earnings proportion}  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(d)(ii)
...
\opt{oldrules}{, except where paragraph (3) or paragraph (4) applies,}  % Words inserted (18.4.95) by SI 1995/1045 reg 17(2), omitted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(d)(iii)(aa)
be an amount equal to 
\opt{oldrules}{the liable person’s exempt income}\opt{newrules}{60\% of the liable person’s net earnings}  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(d)(iii)(bb)
in respect of that period as calculated at the date of the current 
\opt{oldrules}{assessment}\opt{newrules}{maintenance calculation}.  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(d)(iii)(cc)

%Reg 11(3), (4) inserted (18.4.95) by SI 1995/1045 reg 17(3), omitted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(d)(iv)
\opt{oldrules}{(3) Where an interim maintenance assessment%
...
\opt{oldrules}{protected earnings rate}\opt{newrules}{protected earnings proportion}  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(e)(i)
...
\opt{oldrules}{assessment}\opt{newrules}{calculation};  % Word substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(f)(i)

($b$) where any arrears% 
\opt{oldrules}{ and interest on arrears}\opt{newrules}{, penalty payment, interest or fees}  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(f)(ii)
...
\opt{oldrules}{an interim maintenance assessment}\opt{newrules}{a default or interim maintenance decision},  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(g)(i)
...
\opt{oldrules}{maintenance assessment}\opt{newrules}{maintenance calculation}  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(g)(ii)
...
\opt{oldrules}{or (5)}   % Words omitted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(5)(h)
from a time prior to the revival of the order.

\opt{newrules}{
\amendment{
Words omitted in reg. 21(6) (3.3.03 for new-rules cases only) by the Child Support (Collection and Enforcement and Miscellaneous Amendments) Regulations 2000 reg. 2(5)(h) (subject to savings in reg. 6).
}
}
...
% Reg 24(1) omitted (3.3.03 for old-rules cases only) by SI 2001/162 reg 2(5)(i)(i)
24.—\opt{oldrules}{(1) Where an employer would, but for this paragraph, be obliged, on any pay-day, to make deductions under two or more deduction from earnings orders he shall—
\begin{enumerate}\item[]
...
\opt{oldrules}{one or more deduction from earnings orders}\opt{newrules}{a deduction from earnings order}  % Words substituted (3.3.03 for old-rules cases only) by SI 2001/162 reg 2(5)(i)(iii)(aa)
...
\opt{oldrules}{or orders}  % Words omitted (3.3.03 for old-rules cases only) by SI 2001/162 reg 2(5)(i)(iii)(bb)
...
($b$) in the case of any other attachment of earnings order\opt{oldrules}{, deal with the orders according to the respective dates on which they were made in like manner as under paragraph (1).}\opt{newrules}{
he shall—
\begin{enumerate}\item[]
...
\end{enumerate}
} % Words substituted (3.3.03 for old-rules cases only) by SI 2001/162 reg 2(5)(i)(ii)
\end{enumerate}
...
\opt{oldrules}{ in respect of arrears payable under section 41(3) of the Act\footnote{\frenchspacing See The Child Support (Arrears, Interest and Adjustment of Maintenance Assessments) Regulations 1992, S.I. 1992/1816.}}\opt{newrules}{, penalty payments or fees which have become payable and have not been paid}.  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(6)(a)
...
\opt{oldrules}{40}\opt{newrules}{39A}  % Word substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(6)(b)(i) 
...
\opt{oldrules}{section 40}\opt{newrules}{sections 39A and 40}  % Words substituted (3.3.03 for new-rules cases only) by SI 2001/162 reg 2(6)(b)(ii) 
...
\opt{oldrules}{or }% Word omitted (3.3.03) by SI 2001/162 reg 2(8)(b)
...
\opt{oldrules}{or }% Word omitted (3.3.03) by SI 2001/162 reg 2(8)(c)
...
\opt{newrules}{penalty payments, fees, }% Words inserted (3.3.03) by SI 2001/162 reg 2(8)(a)
costs and charges):
