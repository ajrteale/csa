...
\amendment{
\opt{newrules}{
Words inserted in reg.~3(1), word substituted in reg.~3(2) (3.3.03 for new-rules cases only) and r}\opt{oldrules}{R}eg. 3(1)(f), (1A) inserted (3.3.03 for new-rules cases only, 12.7.06 for all other purposes) by the Child Support (Collection and~Enforcement and~Miscellaneous Amendments) Regulations 2000 reg.~2(3)(a), (b), (c) (subject to~savings in reg.~6).
...
\opt{oldrules}{as calculated at the date of the current 
%\opt{oldrules}{
assessment%
%}\opt{newrules}{maintenance calculation}
