...
%net 
\emph{gross}  % Word substituted (10.12.12) by SI 2012/2785 reg 4(7)
...
For 1993 and 2003 scheme cases, the reference in reg.~25C(1)(a) to gross weekly income should be read as a reference to net weekly income.
}
...
%net 
\emph{gross}  % Word substituted (10.12.12 for 2012 scheme cases only) by SI 2012/2785 reg 4(7)
...
For 1993 and 2003 scheme cases, the reference in reg.~25G(2)(d) to gross weekly income should be read as a reference to net weekly income.
}
