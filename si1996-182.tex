...
\pagestyle{fancy}
\fancyhead[L]{}
\fancyhead[C]{\itshape The Social Security (Adjudication) and Child Support Amendment Regulations 1996 (S.I.~1996/182) \parthead%\phantom{...}% (\versionyear{} scheme version)
}
\fancyhead[R]{}
\fancyfoot[C]{\thepage}
\newcommand{\parthead}{}
